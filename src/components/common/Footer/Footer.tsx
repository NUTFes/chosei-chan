  ...
  return (
    <footer className='footer bg-neutral p-1 md:p-4 text-neutral-content'>
      <div className='w-full grid-flow-col items-center'>
        ...
        <div className='text-xs md:text-base md:place-self-center'>
          Copyright © 2023 - NUTMEG
        </div>
        <div className='flex gap-1 md:gap-4 md:place-self-center md:justify-self-end'>
          <a
